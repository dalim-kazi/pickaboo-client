...
import ProductsCard from "../../../../component/ProductsCard/ProductsCard";
    ...
    const MensSandal = () => {
        ...
        const FormalShoeProducts = mensProduct.filter(item => item.subCategory === "sandals")
        ...
        return (
            <>
             <p className="text-2xl mt-20 mx-10 text-orange-600 border-b-2 text-center">Mens Sandal Collection</p>
